...
public class SeanceAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, int position) {
        ...
        ((TextView)holder.itemView.findViewById(R.id.tvHeureDebutSe)).setText(seance.get_horaire().getHeureDebut());
        ((TextView)holder.itemView.findViewById(R.id.tvHeureFinSe)).setText(seance.get_horaire().getHeureFin());
