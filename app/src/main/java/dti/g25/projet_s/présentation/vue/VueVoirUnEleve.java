...
public class VueVoirUnEleve extends Fragment implements IContratVuePrésenteurVoirUnEleve.IPrésenteurVoirUnEleve, SingleChoiceDialogHeuresAbsenceFragment.SingleChoiceListener {
    ...
    public View onCreateView (LayoutInflater inflater,
        ...
        btnAbsence.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                try {
                    Absence uneAbsence = new Absence(nbHeures, leUser);
                } catch (Exception e) {
                    e.printStackTrace();
                }
            }
